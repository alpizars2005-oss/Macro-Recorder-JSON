...
def default_data_root() -> Path:
    ...
    Source checkouts keep their existing project-local data folders. Packaged
    Windows builds use LocalAppData so the application remains writable even
    when installed under a protected folder. A dedicated environment variable
    is available for tests and portable use.
    """
